...
- you can reuse Beda EMR containers (`PatientList`, `EncounterList`, etc.) or build custom pages with `ResourceListPage` and [`ResourceDetailPage`](./resource-detail-page.md).
